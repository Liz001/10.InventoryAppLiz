...
import static com.example.android.inventoryappliz.R.id.decrease_quantity;
...
public class InventoryEditor extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        decreaseQuantity = (ImageButton) findViewById(decrease_quantity);
    ...
    private void saveProduct() {
        ...
        values.put(InventoryContract.InventoryEntry.COL_NAME, nameString);
        values.put(InventoryContract.InventoryEntry.COL_DESCRIPTION, descriptionString);
        values.put(InventoryContract.InventoryEntry.COL_QUANTITY, inventoryString);
        values.put(InventoryContract.InventoryEntry.COL_ITEMS_SOLD, salesString);
        values.put(InventoryContract.InventoryEntry.COL_PRICE, priceString);
        values.put(InventoryContract.InventoryEntry.COL_SUPPLIER, supplierString);
        values.put(InventoryContract.InventoryEntry.COL_PICTURE, mCurrentPhotoUri);
